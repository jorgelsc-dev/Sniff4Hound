...
<script>
// Rutas identicas a desktop/frontend/src/components/brand/BrandMark.vue: la landing y el
// panel dibujan exactamente la misma marca. Aqui se omiten el halo difuminado y la
// animacion del gradiente que el componente del panel ofrece como opcionales.
...
// Los ids de gradiente son globales al documento: dos marcas en la misma pagina
// con el mismo id harian que la segunda reutilizase el gradiente de la primera.
...
export default {
  ...
  computed: {
    ...
    gradientId() {
      return `brand-mark-${this.instanceId}-gradient`;
    },
  },
};
</script>
