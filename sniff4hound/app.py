...
ENDPOINTS = [
    ...
    {"method": "GET", "path": "/api/blacklist/", "desc": "List blacklist entries (optionally filtered by ?category=ip|domain|path|port|protocol)."},
    ...
    {"method": "GET", "path": "/api/whitelist/", "desc": "List whitelist entries (optionally filtered by ?category=ip|domain|path|port|protocol)."},
