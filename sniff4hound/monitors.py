...
DEFAULT_MONITORS = [
    ...
    },
    {
        ...
        "name": "TCP RST/ACK rejection",
        "description": "RST+ACK responses - individually normal, but the reply pattern a port scan leaves behind on closed ports.",
        "enabled": False,
        "priority": 90,
        "source": "builtin",
        "mode": "rule",
        "match": {"protocols": ['tcp'], "tcp_flags": ['RST,ACK']},
        "action": {"tag": "tcp-reset", "label": "TCP reset", "severity": "info"},
    },
    {
