...
MONITOR_REGEX_TIMEOUT_SECONDS = max(
    0.001,
    _as_float(_env("SNIFF4HOUND_MONITOR_REGEX_TIMEOUT_SECONDS", "0.025"), 0.025),
)

HONEYPOT_TCP_MAX_CONNECTIONS_PER_LISTENER = max(
    1,
    _as_int(_env("SNIFF4HOUND_HONEYPOT_TCP_MAX_CONNECTIONS_PER_LISTENER", "64"), 64),
)
HONEYPOT_UDP_RESPONSE_RATE_WINDOW_SECONDS = max(
    1,
    _as_int(_env("SNIFF4HOUND_HONEYPOT_UDP_RESPONSE_RATE_WINDOW_SECONDS", "1"), 1),
)
HONEYPOT_UDP_RESPONSE_RATE_LIMIT = max(
    1,
    _as_int(_env("SNIFF4HOUND_HONEYPOT_UDP_RESPONSE_RATE_LIMIT", "20"), 20),
)
HONEYPOT_UDP_RESPONSE_RATE_MAX_CLIENTS = max(
    64,
    _as_int(_env("SNIFF4HOUND_HONEYPOT_UDP_RESPONSE_RATE_MAX_CLIENTS", "4096"), 4096),
)
