...
export default {
  ...
  mounted() {
    ...
    document.addEventListener("keydown", this.handleToolsMenuKeydown);
  },
  beforeUnmount() {
    ...
    document.removeEventListener("keydown", this.handleToolsMenuKeydown);
  },
  methods: {
    toggleToolsMenu() {
    ...
    handleToolsMenuKeydown(event) {
      if (event.key === "Escape" && this.toolsMenuOpen) {
        this.closeToolsMenu();
      }
    },
